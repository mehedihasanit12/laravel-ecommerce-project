                                ...
                                <div class="reviews_wrapper">
                                    ...
                                    <div class="reviews_comment_box">
                                        <div class="comment_thmb">
                                            <img src="{{asset('/')}}website/assets/img/blog/comment2.jpg" alt="">
                                        </div>
                    ...
                    <div class="product_carousel product_column4 owl-carousel">
                        @foreach($category_products as $category_product)
                            ...
                            <div class="product_thumb">
                                <a href="{{route('product-detail', ['id' => $category_product->id])}}"><img src="{{asset($category_product->image)}}" alt=""></a>
                            ...
                            <div class="product_content">
                                <div class="product_name">
                                    <h3><a href="{{route('product-detail', ['id' => $category_product->id])}}">{{$category_product->name}}</a></h3>
                                </div>
                                <div class="product_rating">
                                    <ul>
                                        <li><a href="#"><i class="zmdi zmdi-star-outline"></i></a></li>
                                ...
                                <div class="price_box">
                                    <span class="current_price">BDT {{$category_product->selling_price}}</span>
                                    <span class="old_price">BDT {{$category_product->regular_price}}</span>
                                </div>
                                <div class="action_links">
                                    <ul>
                                        <li class="wishlist"><a href="wishlist.html" title="Add to Wishlist"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
                                        <li class="add_to_cart"><a href="{{route('cart.direct-add', ['id' => $category_product->id])}}" title="add to cart"><i class="zmdi zmdi-shopping-cart-plus"></i> add to cart</a></li>
                                        <li class="compare"><a href="#" title="compare"><i class="zmdi zmdi-swap"></i></a></li>
                                    </ul>
                                </div>
                            </div>
